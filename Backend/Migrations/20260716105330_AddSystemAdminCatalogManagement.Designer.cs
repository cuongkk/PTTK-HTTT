...
namespace Backend.Migrations
{
    ...
    [Migration("20260716105330_AddSystemAdminCatalogManagement")]
    partial class AddSystemAdminCatalogManagement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.HandoverDetail", b =>
                {
                    ...
                    b.Property<string>("HandoverReportHandoverId")
                        .HasColumnType("nvarchar(12)");
                    ...
                    b.HasIndex("HandoverReportHandoverId");
            ...
            modelBuilder.Entity("Backend.Models.ServiceRate", b =>
                {
                    b.Property<string>("ServiceRateId")
                        .HasMaxLength(12)
                        .HasColumnType("nvarchar(12)")
                        .HasColumnName("ma_gia_ap_dung");
                    ...
                    b.HasKey("ServiceRateId")
                        .HasName("pk_gia_dich_vu_ap_dung");
                    ...
                    b.HasIndex("ServiceId", "BranchId")
                        .IsUnique()
                        .HasDatabaseName("uq_giadv_dichvu_chinhanh")
                        .HasFilter("[ma_chi_nhanh] IS NOT NULL");

                    b.HasIndex("ServiceId", "RoomId")
                        .IsUnique()
                        .HasDatabaseName("uq_giadv_dichvu_phong")
                        .HasFilter("[ma_phong] IS NOT NULL");

                    b.ToTable("gia_dich_vu_ap_dung", null, t =>
                        {
            ...
            modelBuilder.Entity("Backend.Models.HandoverDetail", b =>
                {
                    ...
                    b.HasOne("Backend.Models.HandoverReport", null)
                        ...
                        .HasForeignKey("HandoverReportHandoverId");
                });
