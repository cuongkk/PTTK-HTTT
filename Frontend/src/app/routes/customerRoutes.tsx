...
import { CustomerRooms, ViewingAppointment, DepositRequest, DepositTermsConfirmation, DepositPayment, DepositRefundRequest, CustomerCheckIn, CheckInPayment, HandoverConfirmation, CheckoutRequestPage, CheckoutReconciliation } from "../components/customer/CustomerWorkflowPages";
...
export const customerRoutes: RouteObject = {
  ...
  children: [
    ...
    { path: "deposit-refunds/:roomId", Component: DepositRefundRequest },
