...
import { CustomerRooms, DepositRequest, DepositPayment, CustomerCheckIn, CheckInPayment, HandoverConfirmation, CheckoutReconciliation, CheckoutSettlement, LiquidationConfirmation } from "../components/customer/CustomerWorkflowPages";
...
export const customerRoutes: RouteObject = {
  ...
  children: [
    ...
    { path: "handovers/:handoverId", Component: HandoverConfirmation }, { path: "checkouts/:checkoutId/reconciliation", Component: CheckoutReconciliation },
