...
import { AssignRoomViewing } from "../components/sales/AssignRoomViewing";
import { ReviewDeposit } from "../components/sales/ReviewDeposit";
import { ReviewCheckin } from "../components/sales/ReviewCheckin";
...
export const salesRoutes: RouteObject = { path: "sales", children: [
  ...
  { path: "assign-room", Component: AssignRoomViewing },
  { path: "review-deposit", Component: ReviewDeposit },
  { path: "review-checkin", Component: ReviewCheckin },
] };
